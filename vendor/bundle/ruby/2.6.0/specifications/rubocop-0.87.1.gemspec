...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rubocop-hq/rubocop/issues", "changelog_uri" => "https://github.com/rubocop-hq/rubocop/blob/master/CHANGELOG.md", "documentation_uri" => "https://docs.rubocop.org/", "homepage_uri" => "https://rubocop.org/", "source_code_uri" => "https://github.com/rubocop-hq/rubocop/" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<parser>.freeze, [">= 2.7.1.1"])
      s.add_runtime_dependency(%q<rainbow>.freeze, [">= 2.2.2", "< 4.0"])
      s.add_runtime_dependency(%q<regexp_parser>.freeze, [">= 1.7"])
      s.add_runtime_dependency(%q<rexml>.freeze, [">= 0"])
      s.add_runtime_dependency(%q<rubocop-ast>.freeze, [">= 0.1.0", "< 1.0"])
      ...
      s.add_dependency(%q<parser>.freeze, [">= 2.7.1.1"])
      s.add_dependency(%q<rainbow>.freeze, [">= 2.2.2", "< 4.0"])
      s.add_dependency(%q<regexp_parser>.freeze, [">= 1.7"])
      s.add_dependency(%q<rexml>.freeze, [">= 0"])
      s.add_dependency(%q<rubocop-ast>.freeze, [">= 0.1.0", "< 1.0"])
